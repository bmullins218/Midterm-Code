...
public abstract class Person implements java.io.Serializable {
	...
	public Date getDOB() throws PersonException{
		...
		if (rightnow.get(Calendar.YEAR)-
				birthdate.get(Calendar.YEAR)>100){
			System.out.println("This date of birth is invalid");
			throw new PersonException(this.DOB);
		}
		else{
			System.out.println("This is a valid date of birth");
			return DOB;	
		}
	}
	...
	public String getPhone() throws PersonException {
		...
		//System.out.println(this.email_address +" : "+ matcher.matches());
		...
		if(matcher.matches()){
			...
			//If phone number is incorrect then throw new phone exception in PersonException
